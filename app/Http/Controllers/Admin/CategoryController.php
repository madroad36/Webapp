...
class CategoryController extends Controller
{
    ...
    {
        return view('layouts.backend.category.view');
    }
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return redirect('admin/category')->with('errors','Category cannot be created successfully');
    ...
    public function edit($id)
    {
        ...
        return view('layouts.backend.category.edit')->withCategory($category);
    ...
    public function update(CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('admin/category')->with('errors','Category cannot be update successfully');
    ...
    public function getdata(){
        ...
        return \DataTables::of($categorys)
            ->addColumn('action', function ($categorys) {
                    return '<a href="'.asset("admin/category/edit/$categorys->id").'" class="btn btn-xs btn-primary btn-icon btn-rounded"  title="Edit-category"
