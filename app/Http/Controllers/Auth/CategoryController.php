...
class CategoryController extends Controller
{
    ...
    public function store(CategoryStoreRequest $request)
    {
        ...
        return redirect('/category')->with('errors','Category cannot be created successfully');
    ...
    public function update(CategoryUpdateRequest $request, $id)
    {
        ...
        return redirect('/category')->with('errors','Category cannot be update successfully');
        ...
        return \DataTables::of($categorys)
            ->addColumn('action', function ($categorys) {
                ...
                if(auth()->user()->can('edit-category')) {
                    $data .='<a href="' . asset("category/edit/$categorys->id") . '" class="btn btn-xs btn-primary btn-icon btn-rounded"  title="Edit-category"
