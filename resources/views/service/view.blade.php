...
<div class="container">
    <h3 class="profile-menu-title">List of Order services</h3>
            ...
            <div class="service-lists">
                ...
                <div class="service-details">
                    <div class="service-content">
                        ...
                        <p>Numbers of Order:<span>{{$servicerequest->order->count()}} </span></p>
                        <p>Recently:<span>{{$servicerequest->updated_at->format('d M Y')}}</span></P>
                        </div>
                        <div class="service-brnt auth-order-service">
                            ...
                            <a href="{{route('order.service.show',[$servicerequest->id])}}" class="btn  edit-btn">View Details</a>
                        </div>
                    </div>
                </div>
