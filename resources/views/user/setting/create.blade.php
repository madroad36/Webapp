        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('setting.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; View Setting</a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>'setting.store','class'=>'','enctype'=>'multipart/form-data')) !!}
