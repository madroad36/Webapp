                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('setting.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Setting</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.datatable').on('click','#delete-setting',function(event){
                ...
                var url = baseUrl+"/setting/delete/"+id;
                swal({
                    title: 'Are you sure?',
            ...
            $(".datatable").on("click", "#change-status", function () {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('setting.change-status') }}",
                            data: {
                                'id': id,
                            },
                            headers: {
