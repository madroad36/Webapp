                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('auth.property_category.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Property Category </a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".datatable").DataTable({
                ...
                ajax: {
                    url:'{{route('auth.property_category.getdata')}}',
                    type:"GET",
                    cache: false
                },
                columns: [
            ...
            $('.datatable').on('click','#delete-category',function(event){
                ...
                var url = baseUrl+"/auth/property_category/delete/"+id;
                swal({
                    title: 'Are you sure?',
            ...
            $(".datatable").on("click", "#change-status", function () {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('auth.property_category.change-status') }}",
                            data: {
                                'id': id,
                            },
                            headers: {
