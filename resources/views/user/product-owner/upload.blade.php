        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('auth.product_image.index',[$product->id])}}" style="float:right">View Image</a>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['auth.product_image.store',$product->id],'class'=>'dropzone','id'=>'dropzone_accepted_files','enctype'=>'multipart/form-data')) !!}
