        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('auth.product_owner.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; View Product </a>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-8  col-xs-offset-2">
                            ...
                            {!! Form::open(array('route'=>'auth.product_owner.store','class'=>'','enctype'=>'multipart/form-data')) !!}
