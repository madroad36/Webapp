        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('auth.place.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; View Place </a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>'auth.place.store','class'=>'','enctype'=>'multipart/form-data')) !!}
