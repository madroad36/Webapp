                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('auth.place.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Place </a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.datatable').on('click','#delete-location',function(event){
                ...
                var url = baseUrl+"/auth/place/delete/"+id;
                swal({
                    title: 'Are you sure?',
            ...
            {{--$(".datatable").on("click", "#change-status", function () {--}}
                ...
                {{--}).then((result) => {--}}
                    {{--if (result.value) {--}}
                        {{--$.ajax({--}}
                            {{--type: "POST",--}}
                            {{--url: "{{ route('auth.place.change-status') }}",--}}
                            {{--data: {--}}
                                {{--'id': id,--}}
                            {{--},--}}
                            {{--headers: {--}}
