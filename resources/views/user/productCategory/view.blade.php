                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('auth.product_category.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Create Product Category</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".datatable").DataTable({
                ...
                ajax: {
                    url:'{{route('auth.product_category.getdata')}}',
                    type:"GET",
                    cache: false
                },
                columns: [
            ...
            $('.datatable').on('click','#delete-category',function(event){
                ...
                var url = baseUrl+"/auth/product_category/delete/"+id;
                swal({
                    title: 'Are you sure?',
            ...
            $(".datatable").on("click", "#change-status", function () {
                ...
                swal({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "POST",
                            url: "{{ route('auth.product_category.change-status') }}",
                            data: {
                                'id': id,
                            },
                            headers: {
