...
@section('title', 'Edit Property Subcategory')
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Edit Property SubCategory</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Edit Property SubCategory</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['auth.property_subcategory.update',$subcategory->id],'class'=>'','enctype'=>'multipart/form-data')) !!}
