            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['auth.property.update',$property->id],'class'=>'','enctype'=>'multipart/form-data')) !!}
                        ...
                        <!-- text input -->
                                ...
                                <div class="form-group">
                                    ...
                                    @endforeach
                                    {!! Form::select('location_id',$location,$property->location_id,['id'=>'location','class'=>'form-control','placeholder'=>'Select The Location']) !!}
                                ...
                                <div class="form-group">
                                    <label>Area</label>
                                    {!! Form::select('place_id',[],$property->place_id,['class'=>'form-control','id'=>'place','placeholder'=>'Select The Area']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    @if(file_exists('storage/'.$property->thumbnail) && $property->thumbnail != '')
                                        <img id="upload-image" src="{{asset('storage/'.$property->thumbnail)}}" alt="your image" style="display:block;width:200px;height:200px;margin-left:30%;margin-top: -6%;"/>
                                ...
                                <div class="form-group">
                                    <label>Owner Image {{$property->property_image}}</label>
                                    ...
                                    <img id="upload-property-image" src="{{asset('storage/'.$property->property_image)}}" alt="your image" style="display:block;width:200px;height:200px;margin-left:30%;margin-top: -6%;"/>
