        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Edit Service Sub Category</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['admin.service_sub_category.update',$subcategory->id],'class'=>'','enctype'=>'multipart/form-data')) !!}
                        ...
                        <!-- text input -->
                                <div class="form-group">
                                    ...
                                    @endforeach
                                    {!! Form::select('category_id',$cat,$subcategory->category_id,['class'=>'form-control','id'=>'category','placeholder'=>'Select The Category']) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    @if(file_exists('storage/'.$subcategory->image) && $subcategory->image != '')
                                        <img id="upload-image" src="{{asset('storage/'.$subcategory->image)}}" alt="your image" style="display:display:block;width:200px;height:200px;margin-left:30%;margin-top: -6%;"/>
