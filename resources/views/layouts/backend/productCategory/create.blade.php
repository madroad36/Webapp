        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('admin.product_category.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; View Product Category</a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>'admin.product_category.store','class'=>'','enctype'=>'multipart/form-data')) !!}
