                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            @can('isAdmin')
                            <a href="{{route('admin.product_category.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Create Product Category</a>
                            @endcan
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".datatable").DataTable({
                ...
                ajax: {
                    url:'{{route('admin.product_category.getdata')}}',
                    type:"GET",
                    cache: false
                },
                columns: [
            ...
            $('.datatable').on('click','#delete-category',function(event){
                ...
                var url = baseUrl+"/admin/product_category/delete/"+id;
                swal({
                    title: 'Are you sure?',
