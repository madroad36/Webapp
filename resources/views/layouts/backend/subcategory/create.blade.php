    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add Property Sub Category</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Add Property Sub Category</h3>
                    <a href="{{route('admin.subcategory.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; Add Property Subcategory</a>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>'admin.subcategory.store','class'=>'','enctype'=>'multipart/form-data')) !!}
