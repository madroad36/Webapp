                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            @can('isAdmin')
                            <a href="{{route('admin.subcategory.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Property Subcategory</a>
                            @endcan
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".datatable").DataTable({
                ...
                ajax: {
                    url:'{{route('admin.subcategory.getdata')}}',
                    type:"GET",
                    cache: false
                },
                columns: [
            ...
            $('.datatable').on('click','#delete-category',function(event){
                ...
                var url = baseUrl+"/admin/subcategory/delete/"+id;
                swal({
                    title: 'Are you sure?',
