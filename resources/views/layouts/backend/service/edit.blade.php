            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['admin.service.update',$service->id],'class'=>'','enctype'=>'multipart/form-data')) !!}
...
{{--                                    {!! Form::select('subcategory_id',[],$service->subcategory_id,['class'=>'form-control','id'=>'subcategory','placeholder'=>'Select The Subcategory']) !!}--}}
...
{{--                                </div>--}}
                                {{--<div class="form-group">--}}
                                    ...
                                    {{--@endforeach--}}
                                    {{--{!! Form::select('location_id',$location,$service->location_id,['id'=>'location','class'=>'form-control','placeholder'=>'Select The Location']) !!}--}}
                                ...
                                {{--<div class="form-group">--}}
                                    {{--<label>Place</label>--}}
                                    {{--{!! Form::select('place_id',[],$service->place_id,['class'=>'form-control','id'=>'place','placeholder'=>'Select The Area']) !!}--}}

                                {{--</div>--}}
                                <div class="form-group">
                                    <lable>Rate</lable>
                                    <input type="number" name="rate" placeholder="Please insert rate" min="0" value="{{$service->rate}}" class="form-control">

                                </div>
                                <div class="form-group">
                                    <label for="">Rate Type</label>
                                    <select name="rate_type" class="form-control" id="">
                                        <option @if($service->rate_type == 'half-hourly') selected @endif value="half-hour" >Half-Hourly</option>
                                        <option @if($service->rate_type == 'hourly') selected @endif value="hourly" >Hourly</option>
                                        <option @if($service->rate_type == 'per-day') selected @endif value="per-day">Per-Day</option>
                                    </select>
                                </div>
                            <div class="form-group">
                                <label>Image</label>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(window).load(function() {
                var value = $('#location  option:selected').val();
