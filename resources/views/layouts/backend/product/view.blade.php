                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            @can('isAdmin')
                            <a href="{{route('admin.product.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Create Product </a>
                            @endcan
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.datatable').on('click','#delete-product',function(event){
                ...
                var url = baseUrl+"/admin/product/delete/"+id;
                swal({
                    title: 'Are you sure?',
