            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        {!! Form::open(array('route'=>['admin.product.update',$product->id],'class'=>'','enctype'=>'multipart/form-data')) !!}
                        ...
                        <!-- text input -->
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit" id="" class="form-control" >
                                        ...
                                        <option value="per piece" @if($product->unit == 'per piece')  @endif>Per Piece</option>
                                        <option value="dozen" @if($product->unit == 'dozen')  @endif>Dozen</option>
                                    </select>
                                    @if ($errors->has('unit'))
                                ...
                                <div class="form-group">
                                    ...
                                    @if(file_exists('storage/'.$product->image) && $product->image != '')
                                        <img id="delete-image" src="{{asset('storage/'.$product->image)}}" alt="{{$product->title}}" style="width:100px; height:100px;margin-top: 20px;">
                                    @endif
