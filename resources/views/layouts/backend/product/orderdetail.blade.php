...
<div class="modal fade product-order-detail" tabindex="-1" id="property-add" data-backdrop="false" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="true">
                            ...
                            <div class="card card-elegant">
                                ...
                                @endif
                                   ...
                                   <span><strong>Title:</strong>{{$order->product->title}}</span>
                                    ...
                                    <span><strong>Stock:</strong>{{$order->product->quantity}}</span>
