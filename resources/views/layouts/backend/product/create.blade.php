        ...
        <section class="content">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="{{route('admin.product.index')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-eye" aria-hidden="true"></i> &nbsp; View Product </a>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-xs-8  col-xs-offset-2">
                            ...
                            {!! Form::open(array('route'=>'admin.product.store','class'=>'','enctype'=>'multipart/form-data')) !!}
                        ...
                        <!-- text input -->
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="number" min="0" name="price" class="form-control" placeholder="Price" value="{{ old('price') }}">
                                    @if ($errors->has('price'))
