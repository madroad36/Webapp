			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						...
						<a href="{{route('admin.slider.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Slider</a>
...
<script type="text/javascript">
	$(document).ready(function() {
		$(".datatable").dataTable({
			...
			ajax: {
				url:'{{route('admin.slider.getdata')}}',
				type:"GET",
				dataType:'json',
				cache: false
			},
		...
		$('.datatable').on('click','#delete-slider',function(event){
			event.preventDefault();
			$object = $(this);
			var id  = $(this).attr('data-type');
			var url = baseUrl+"/admin/slider/delete/"+id;
			swal({
				title: 'Are you sure?',
