                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <a href="{{route('admin.place.create')}}" class=" btn btn-primary " style="float: right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Place </a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.datatable').on('click','#delete-location',function(event){
                ...
                var url = baseUrl+"/admin/place/delete/"+id;
                swal({
                    title: 'Are you sure?',
