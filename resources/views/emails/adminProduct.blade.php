...
<table class="body-wrap" bgcolor="#f6f6f6">
    ...
    <!-- content -->
    <tr class="container" bgcolor="#FFFFFF"><br><strong>Dear Admin, </strong><br /><p>New Product has been added: </p></tr>
    ...
    <tr class="container" bgcolor="#FFFFFF"><td>Category : {{$request->category->title}}</td></tr>
    <tr class="container" bgcolor="#FFFFFF"><td>Description:{!! $request['description'] !!}</td></tr>
    <tr class="container" bgcolor="#FFFFFF"><td>Image:
            <img src="{{asset('storage/'.$request['image'])}}" alt="{{$request['title']}}">
        </td></tr>
    <!-- footer -->
