<div class="modal  " tabindex="-1" id="property-edit-{{$property->id}}" role="dialog"
                    ...
                    <div class="container-fluid" id="grad1">
                        <div class="row justify-content-center mt-0">
                            <div class="col-lg-12  text-center ">
                                {!! Form::open(array('route'=>['property.update',$property->id],'method'=>'Post','id'=>'property-edit-popup','enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    {{--@php $sub[$subcategory->id] = $subcategory->name @endphp--}}
                                                    {{--@endforeach--}}

                                                    {{--{!! Form::select('subcategory_id',[],['class'=>'form-control edit-form-input','id'=>'subcategory','placeholder'=>'Select The Sub-Category']) !!}--}}
                                                    {!! Form::select('subcategory_id',[],$property->subcategory_id,['class'=>'form-control edit-form-input','id'=>'subcategory','placeholder'=>'Choose sale/rent']) !!}
                                            ...
                                            <div class="col-lg-3">
                                                <div class=" form-group">
                                                    ...
                                                    <select name="drainage" id="" class="form-control edit-form-input">
                                                        ...
                                                        <option value="Sewagel"
                                                                @if($property->drainage == 'Sewagel')selected @endif>
                                                            Sewage
                                                        </option>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group {{$errors->has('citizen') ?  'has-error' :''}}">
                                                        ...
                                                        <input type="number" name="citizen" class="form-control"
                                                               placeholder="Citizenship Number" {{$property->citizen}}
                                                        />
                                                ...
                                                <div class="col-lg-6">
                                                    <div id="hide-upload" class="ownerUpload">
                                                        ...
                                                        @if(file_exists('storage/'.$property->owner_image) && $property->owner_image !=='')
                                                            <img src="{{asset('storage/'.$property->owner_image)}}"
                                                                 id="ownerPreview" alt="Preview Image"
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <div id="hide-upload" class="paperUpload">
                                                        ...
                                                        <img src="" id="lalapurjaPreview" alt="Preview Image"
                                                             style="display:none;width:100px;height:100px; padding-top: 20px;     right: 15%;"/>
                                                        @if(file_exists('storage/'.$property->property_paper) && $property->property_paper !=='')
                                                            <img src="{{asset('storage/'.$property->property_paper)}}"
                                                                 id="lalapurjaPreview" alt="Preview Image"
                                                                 style="width:100px;height:100px; padding-top: 20px;     right: 24%;"/>
                                                        @endif
                                                    </div>
