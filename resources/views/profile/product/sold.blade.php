...
@section('main-content')
    ...
    <div class="container">
        <h3 class="profile-menu-title">List of Sold Product</h3>
                        ...
                        <div id="product-{{$order->id}}">
                            <div class="card" style="width: 18rem; border: 1px solid #000000;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="javascript:void(0)" data-type="{{$order->id}}" class="card-link sold " id="change-status">Sold
                                    </a>
                                        @else
                                        <a href="javascript:void(0)" data-type="{{$order->id}}" class="card-link unsold " id="change-status">Unsold
                                        </a>
                                    @endif
                                </div>
                            </div>
